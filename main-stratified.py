...
import numpy as np
import os
from data_loading.data_loader import createStraitifedDataLoaders
...
train_loader, val_loader = createStraitifedDataLoaders(all_images, all_labels, training_ratio = TRAIN_RATIO, val_ratio = VAL_RATIO, batch_size = BATCH_SIZE)
