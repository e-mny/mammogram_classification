...
from cifar import CustomResNet50, train, test
...
def main() -> None:
    ...
    # Start client
    client = CBISClient(model, train_loader, val_loader, test_loader, num_examples, TRAIN_EPOCHS, DEVICE)
